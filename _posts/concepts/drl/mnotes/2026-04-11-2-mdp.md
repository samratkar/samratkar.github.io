...
3. **Transition Probability ($P(s'\mid s,a)$)**: The probability of transitioning to state $s'$ given that the agent is in state $s$ and takes action $a$.
4. **Reward Function ($R(r\mid s,a)$)**: The probability of receiving reward $r$ given that the agent is in state $s$ and takes action $a$.
