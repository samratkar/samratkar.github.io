...
author : Samrat Kar
---
### Sunday 7-13-2025 - Generative AI System Design - Session 1 - Introduction and overview - Chapter 1
### Reference Text 
...
3. Common examples of Discriminative models are - 
   ...
   While these algorithms can predict a target variable from input features, most of them lack the capability to learn
